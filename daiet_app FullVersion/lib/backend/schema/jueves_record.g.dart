...
part of 'jueves_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<JuevesRecord> _$juevesRecordSerializer =
    new _$JuevesRecordSerializer();

class _$JuevesRecordSerializer implements StructuredSerializer<JuevesRecord> {
  @override
  final Iterable<Type> types = const [JuevesRecord, _$JuevesRecord];
  @override
  final String wireName = 'JuevesRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, JuevesRecord object,
  ...
  @override
  JuevesRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new JuevesRecordBuilder();
...
class _$JuevesRecord extends JuevesRecord {
  @override
  ...
  factory _$JuevesRecord([void Function(JuevesRecordBuilder)? updates]) =>
      (new JuevesRecordBuilder()..update(updates))._build();
  ...
  @override
  JuevesRecord rebuild(void Function(JuevesRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  JuevesRecordBuilder toBuilder() => new JuevesRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is JuevesRecord &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'JuevesRecord')
...
class JuevesRecordBuilder
    implements Builder<JuevesRecord, JuevesRecordBuilder> {
  _$JuevesRecord? _$v;
  ...
  JuevesRecordBuilder() {
    JuevesRecord._initializeBuilder(this);
  }

  JuevesRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(JuevesRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$JuevesRecord;
  }

  @override
  void update(void Function(JuevesRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  JuevesRecord build() => _build();

  _$JuevesRecord _build() {
    final _$result = _$v ??
        new _$JuevesRecord._(
            desayuno: desayuno,
            mediodia: mediodia,
            comida: comida,
            merienda: merienda,
