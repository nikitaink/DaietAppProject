...
part of 'martes_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<MartesRecord> _$martesRecordSerializer =
    new _$MartesRecordSerializer();

class _$MartesRecordSerializer implements StructuredSerializer<MartesRecord> {
  @override
  final Iterable<Type> types = const [MartesRecord, _$MartesRecord];
  @override
  final String wireName = 'MartesRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, MartesRecord object,
  ...
  @override
  MartesRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new MartesRecordBuilder();
...
class _$MartesRecord extends MartesRecord {
  @override
  ...
  factory _$MartesRecord([void Function(MartesRecordBuilder)? updates]) =>
      (new MartesRecordBuilder()..update(updates))._build();
  ...
  @override
  MartesRecord rebuild(void Function(MartesRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MartesRecordBuilder toBuilder() => new MartesRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MartesRecord &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MartesRecord')
...
class MartesRecordBuilder
    implements Builder<MartesRecord, MartesRecordBuilder> {
  _$MartesRecord? _$v;
  ...
  MartesRecordBuilder() {
    MartesRecord._initializeBuilder(this);
  }

  MartesRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(MartesRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$MartesRecord;
  }

  @override
  void update(void Function(MartesRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  MartesRecord build() => _build();

  _$MartesRecord _build() {
    final _$result = _$v ??
        new _$MartesRecord._(
            desayuno: desayuno,
            mediodia: mediodia,
            comida: comida,
            merienda: merienda,
