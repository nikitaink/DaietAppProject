...
part of 'domingo_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<DomingoRecord> _$domingoRecordSerializer =
    new _$DomingoRecordSerializer();

class _$DomingoRecordSerializer implements StructuredSerializer<DomingoRecord> {
  @override
  final Iterable<Type> types = const [DomingoRecord, _$DomingoRecord];
  @override
  final String wireName = 'DomingoRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, DomingoRecord object,
  ...
  @override
  DomingoRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new DomingoRecordBuilder();
...
class _$DomingoRecord extends DomingoRecord {
  @override
  ...
  factory _$DomingoRecord([void Function(DomingoRecordBuilder)? updates]) =>
      (new DomingoRecordBuilder()..update(updates))._build();
  ...
  @override
  DomingoRecord rebuild(void Function(DomingoRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DomingoRecordBuilder toBuilder() => new DomingoRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DomingoRecord &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DomingoRecord')
...
class DomingoRecordBuilder
    implements Builder<DomingoRecord, DomingoRecordBuilder> {
  _$DomingoRecord? _$v;
  ...
  DomingoRecordBuilder() {
    DomingoRecord._initializeBuilder(this);
  }

  DomingoRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(DomingoRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$DomingoRecord;
  }

  @override
  void update(void Function(DomingoRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DomingoRecord build() => _build();

  _$DomingoRecord _build() {
    final _$result = _$v ??
        new _$DomingoRecord._(
            desayuno: desayuno,
            mediodia: mediodia,
            comida: comida,
            merienda: merienda,
