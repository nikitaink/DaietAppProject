...
part of 'miercoles_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<MiercolesRecord> _$miercolesRecordSerializer =
    new _$MiercolesRecordSerializer();

class _$MiercolesRecordSerializer
    implements StructuredSerializer<MiercolesRecord> {
  @override
  final Iterable<Type> types = const [MiercolesRecord, _$MiercolesRecord];
  @override
  final String wireName = 'MiercolesRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, MiercolesRecord object,
  ...
  @override
  MiercolesRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new MiercolesRecordBuilder();
...
class _$MiercolesRecord extends MiercolesRecord {
  @override
  ...
  factory _$MiercolesRecord([void Function(MiercolesRecordBuilder)? updates]) =>
      (new MiercolesRecordBuilder()..update(updates))._build();
  ...
  @override
  MiercolesRecord rebuild(void Function(MiercolesRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MiercolesRecordBuilder toBuilder() =>
      new MiercolesRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MiercolesRecord &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MiercolesRecord')
...
class MiercolesRecordBuilder
    implements Builder<MiercolesRecord, MiercolesRecordBuilder> {
  _$MiercolesRecord? _$v;
  ...
  MiercolesRecordBuilder() {
    MiercolesRecord._initializeBuilder(this);
  }

  MiercolesRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(MiercolesRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$MiercolesRecord;
  }

  @override
  void update(void Function(MiercolesRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  MiercolesRecord build() => _build();

  _$MiercolesRecord _build() {
    final _$result = _$v ??
        new _$MiercolesRecord._(
            desayuno: desayuno,
            mediodia: mediodia,
            comida: comida,
            merienda: merienda,
