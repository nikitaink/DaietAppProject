...
part of 'sabado_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<SabadoRecord> _$sabadoRecordSerializer =
    new _$SabadoRecordSerializer();

class _$SabadoRecordSerializer implements StructuredSerializer<SabadoRecord> {
  @override
  final Iterable<Type> types = const [SabadoRecord, _$SabadoRecord];
  @override
  final String wireName = 'SabadoRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, SabadoRecord object,
  ...
  @override
  SabadoRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new SabadoRecordBuilder();
...
class _$SabadoRecord extends SabadoRecord {
  @override
  ...
  factory _$SabadoRecord([void Function(SabadoRecordBuilder)? updates]) =>
      (new SabadoRecordBuilder()..update(updates))._build();
  ...
  @override
  SabadoRecord rebuild(void Function(SabadoRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SabadoRecordBuilder toBuilder() => new SabadoRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SabadoRecord &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SabadoRecord')
...
class SabadoRecordBuilder
    implements Builder<SabadoRecord, SabadoRecordBuilder> {
  _$SabadoRecord? _$v;
  ...
  SabadoRecordBuilder() {
    SabadoRecord._initializeBuilder(this);
  }

  SabadoRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(SabadoRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$SabadoRecord;
  }

  @override
  void update(void Function(SabadoRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SabadoRecord build() => _build();

  _$SabadoRecord _build() {
    final _$result = _$v ??
        new _$SabadoRecord._(
            desayuno: desayuno,
            mediodia: mediodia,
            comida: comida,
            merienda: merienda,
