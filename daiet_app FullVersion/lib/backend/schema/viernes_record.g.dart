...
part of 'viernes_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<ViernesRecord> _$viernesRecordSerializer =
    new _$ViernesRecordSerializer();

class _$ViernesRecordSerializer implements StructuredSerializer<ViernesRecord> {
  @override
  final Iterable<Type> types = const [ViernesRecord, _$ViernesRecord];
  @override
  final String wireName = 'ViernesRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, ViernesRecord object,
  ...
  @override
  ViernesRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ViernesRecordBuilder();
...
class _$ViernesRecord extends ViernesRecord {
  @override
  ...
  factory _$ViernesRecord([void Function(ViernesRecordBuilder)? updates]) =>
      (new ViernesRecordBuilder()..update(updates))._build();
  ...
  @override
  ViernesRecord rebuild(void Function(ViernesRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ViernesRecordBuilder toBuilder() => new ViernesRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ViernesRecord &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ViernesRecord')
...
class ViernesRecordBuilder
    implements Builder<ViernesRecord, ViernesRecordBuilder> {
  _$ViernesRecord? _$v;
  ...
  ViernesRecordBuilder() {
    ViernesRecord._initializeBuilder(this);
  }

  ViernesRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(ViernesRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ViernesRecord;
  }

  @override
  void update(void Function(ViernesRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ViernesRecord build() => _build();

  _$ViernesRecord _build() {
    final _$result = _$v ??
        new _$ViernesRecord._(
            desayuno: desayuno,
            mediodia: mediodia,
            comida: comida,
            merienda: merienda,
